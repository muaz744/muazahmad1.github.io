 ...
 $unpaidCount =  countRow(["table"=>"invoices","where"=>["invoice_status"=>"Unpaid" , "client_id" => $user["client_id"]]]);
	 echo $twig->render( $templateDir.'.twig',
      array(
        ...
        'popupNotif' => $popupNotif , 'ref_content' => $ref_content , 'ref_payouts' => $ref_payouts , 'panels' => $panels , 'invoices' => $invoices , "route" => $routes , "unpaidCount" => $unpaidCount , 'panel'=>$panel, 'general'=>$general, 'updates'=>$updates , 'blogs'=>$blogs, 'blogtitle'=>$blogtitle, 'blogcontent'=>$blogcontent, 'blogimage'=>$blogimage, 'currency'=>$currency, 'currencies'=>$currencies, 'menus'=>$menus, 'MenuSlug'=>$menuslug, 'pageurl'=>$pageurl  , 'pagekeywords'=>$seo_keywords, 'pagetitle'=>$seo_title, 'pagedescription'=>$seo_description , 'PageText'=>$PageText, "news"=>$news,"totalorders"=>$totalorder
      ) 
